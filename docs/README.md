...
- [`../supabase/rpcs.sql`](../supabase/rpcs.sql) — miroir lecture des **134 corps de RPC** (régénéré depuis la prod par le workflow `rpcs-regenerate`, gate CI Arch #5 + prod-drift T-12).
