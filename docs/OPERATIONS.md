...
| Sprint | Date | Scope |
|---|---|---|
| **38 — CPI** | 10/06/2026 | CPI v2.1 (`cooked_page_index`, `cpi_daily`, cron 07:30 UTC) + reprise après-midi : vue `cpi_movers` + alerte `cpi_drop`, harnais de validation J+28 (`scripts/cpi_validation_j28.sql`), idées v2.2 instruites. |
