...
| 10 | RGPD du pont SECIB | **cette semaine (Nicolas)** | La capture PII en clair est ACTIVE depuis le 10/08/2026 : registre des traitements + politique de confidentialité du site à mettre à jour, durée de conservation à fixer (proposition : 24 mois), périmètre secret professionnel à valider avec Julien. |
