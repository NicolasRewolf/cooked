...
-- site_gbp_kpis_compare(p_period_kind text) -> TABLE(period_kind text, period_label_fr text, period_n_start date, period_n_end date, gbp_last_day date, lag_days integer, period_prev_start date, period_prev_end date, call_clicks_n bigint, website_clicks_n bigint, direction_requests_n bigint, conversations_n bigint, impressions_n bigint, call_clicks_prev bigint, website_clicks_prev bigint, direction_requests_prev bigint, conversations_prev bigint, impressions_prev bigint, call_clicks_delta_pct numeric, website_clicks_delta_pct numeric, impressions_delta_pct numeric)
